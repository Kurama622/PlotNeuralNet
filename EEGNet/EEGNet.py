...
arch = [
    ...
    to_Conv('layer2_1', '','','', offset='(4,2,0)',to="(conv2d-east)",width=6, height=1,depth=50, caption=''),
    to_Conv('layer2_2', '','','', offset='(4,0,0)',to="(conv2d-east)",width=6, height=1,depth=50, caption=''),
    to_Conv('layer2_3', 750,1,2, offset='(4,-2,0)',to="(conv2d-east)",width=6, height=1,depth=50, caption='depthwise\_conv2d'),
    to_PoolRelu('pool2_1',offset='(4,0,0)',to="(layer2_1-east)",width=6, height=1,depth=50, caption=''),
    to_PoolRelu('pool2_2',offset='(4,0,0)',to="(layer2_2-east)",width=6, height=1,depth=50, caption=''),
    to_PoolRelu('pool2_3',offset='(4,0,0)',to="(layer2_3-east)",width=6, height=1,depth=50, caption=''),
    ...
    to_Conv('layer3_1','','','',offset='(4,0,0)',to='(pool2_1_0-east)', width=6, height=1, depth=25, caption=''),
    to_Conv('layer3_2','','','',offset='(4,0,0)',to='(pool2_2_0-east)', width=6, height=1, depth=25, caption=''),
    to_Conv('layer3_3',187,'',2,offset='(4,0,0)',to='(pool2_3_0-east)', width=6, height=1, depth=25, caption='separable\_conv2d'),
    to_PoolRelu('pool3_1',offset='(3,0,0)',to="(layer3_1-east)",width=6, height=1,depth=25, caption=''),
    to_PoolRelu('pool3_2',offset='(3,0,0)',to="(layer3_2-east)",width=6, height=1,depth=25, caption=''),
    to_PoolRelu('pool3_3',offset='(3,0,0)',to="(layer3_3-east)",width=6, height=1,depth=25, caption=''),
    ...
    to_Pool('pool3_3_0',187,'','',offset='(0,0,0)',to="(pool3_3-east)",width=2, height=1,depth=10, caption=''),

    to_Flatten('flatten_1', 'z', 276, offset='(3,0,0)', to='(pool3_2_0-east)', width=1,height=1,depth=30,caption='flatten'),
    to_Flatten('out_1', 'z', 4, offset='(2,0,0)', to='(flatten_1-east)', width=1,height=1,depth=4,caption='dense'),
